...
[_LOWER] = LAYOUT_split_3x6_3(
  ...
  KC_LCTL,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,                   KC_END, KC_HOME,KC_RGHT,KC_UP,  KC_DOWN,KC_LEFT,
  KC_LSFT,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,                  _______,_______,KC_DEL, KC_F11, KC_F12, _______,
...
[_RAISE] = LAYOUT_split_3x6_3(
  ...
  KC_LCTL,  _______, RGB_SOFT_OFF, KC_MPRV, KC_MPLY, KC_MNXT,          KC_GRV,  KC_BSLS, KC_RBRC, KC_LBRC, KC_MINS, KC_EQL,
  KC_LSFT,  RGB_TOG, RGB_VAI,   RGB_VAD, KC_VOLD, KC_VOLU,              S(KC_GRV), S(KC_BSLS), S(KC_RBRC), S(KC_LBRC), S(KC_EQL), S(KC_MINS),
                             KC_LGUI, TG(_GAMING), KC_ENT,      KC_SPC, _______, KC_RALT
),

/* GAMING (Both sides active; exit with TG)
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | Esc  |   Q  |   W  |   E  |   R  |   T  |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Ctrl |   A  |   S  |   D  |   F  |   G  |                    |      |      |      |      |      |      |
...
[_GAMING] = LAYOUT_split_3x6_3(
  KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_P,    KC_O,    KC_I,    KC_U,    KC_T,   KC_BSPC,
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_QUOT, KC_SCLN, KC_L,    KC_K,    KC_J,   KC_H,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,                     KC_ESC,  KC_SLSH, KC_DOT,  KC_COMM, KC_M,   KC_N,
                             KC_LALT, KC_SPC, KC_LCTL,      KC_LALT, TG(_GAMING), KC_ENT
),
};
